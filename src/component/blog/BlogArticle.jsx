    ...
    return (
      <div className="max-w-4xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <Link to="/blogs" className="mt-4 inline-block text-indigo-600 hover:text-indigo-800">
            ← Back to blogs
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="bg-white">
      <div className="max-w-4xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        <nav className="mb-8">
          <Link to="/blogs" className="text-indigo-600 hover:text-indigo-800 flex items-center">
