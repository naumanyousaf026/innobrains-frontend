...
const HeroSection = () => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="flex-1 md:pr-8 mb-8 md:mb-0 md:ml-12 flex flex-col items-start">
            <h1 className="poppins-thin tracking-wide text-3xl whitespace-normal  sm:text-4xl md:text-4xl lg:text-5xl font-bold text-gray-800 mb-4">
              We Provide the <span className="text-[#103153]">Best Services</span> for Your Business
            </h1>
            <p className="text-gray-600 mb-6 tracking-wide text-base md:text-lg lg:text-xl poppins-thin leading-6">
              With over 15 years of experience, we offer expert consulting services and innovative business solutions.
            </p>
            <div className="flex items-center space-x-4">
            <Link to='/contact' className="block bg-[#F8AF2A] text-white px-[20px] py-2 rounded-full w-full mt-5 text-center text-base font-semibold">
                  Contact us
  ...
  <div className="relative flex items-center justify-center">
    <div className="bg-yellow-400 rounded-full h-10 w-10 md:h-12 md:w-12 flex items-center justify-center shadow-lg hover:shadow-xl transition-shadow duration-300 z-20">
      <FontAwesomeIcon icon={faPlay} className="text-lg md:text-xl text-white" />
    </div>
    <div className="absolute inset-0 bg-yellow-400 opacity-50 rounded-full blur-md sm:blur-lg"></div>
  </div>
  <div className="mt-2"> {/* Margin-top for spacing */}
    Watch Our Profile
  </div>
</div>
